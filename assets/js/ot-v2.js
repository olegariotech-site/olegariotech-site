(function(){
  ...
  function tuneSolutions(){
    ...
    var railMap={presenca:'Fortalecer minha marca',oferta:'Vender melhor',digital:'Organizar meu digital'};document.querySelectorAll('.desktop-rail [data-solution]').forEach(function(btn){var label=btn.querySelector('span:last-child');if(label&&railMap[btn.dataset.solution])label.textContent=railMap[btn.dataset.solution];});
